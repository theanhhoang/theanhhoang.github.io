...
<div class="container" style="margin-top:60px;">
    <div class="row">
        <div class="col-lg-4 col-lg-offset-4">
            <h1><?php echo $this->lang->line('profile_page'); ?></h1>
            <?php echo form_open('',array('class'=>'form-horizontal'));?>
            <div class="form-group">
                <?php
                echo form_label($this->lang->line('first_name'),'first_name');
            ...
            <div class="form-group">
                <?php
                echo form_label($this->lang->line('last_name'),'last_name');
            ...
            <div class="form-group">
                <?php
                echo form_label($this->lang->line('company'),'company');
            ...
            <div class="form-group">
                <?php
                echo form_label($this->lang->line('phone'),'phone');
            ...
            <div class="form-group">
                <?php
                echo form_label($this->lang->line('confirm_password'),'password_confirm');
                echo form_error('password_confirm');
                echo form_password('password_confirm','','class="form-control"');
                ?>
            </div>
            <?php echo form_submit('submit', $this->lang->line('save_profile'), 'class="btn btn-primary btn-lg btn-block"');?>
            <?php echo form_close();?>
        </div>
    </div>
</div>
...
$(window ).load(function() {
  ...
  // Run code
  $("#top_menu_profile").addClass("active");
  });
</script>
